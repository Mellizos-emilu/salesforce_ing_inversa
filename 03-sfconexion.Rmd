...
# 5. Items de la lista HTML (Panel izquierdo)
html_items <- paste0(
...
'   </div>
  ...
  <div style="flex: 1; background-color: #1e1e1e; display: flex; flex-direction: column; overflow: hidden;">
    ...
    <div style="flex: 1; overflow: auto; background-color: #1e1e1e;">
      <div style="display: flex; padding: 15px; min-width: max-content;">
        
        <div id="numeros-linea" style="padding-right: 15px; margin-right: 15px; text-align: right; color: #6e7681; font-family: Consolas, monospace; font-size: 13px; line-height: 1.5; border-right: 1px solid #404040; user-select: none; white-space: pre;">1\n2\n3\n4</div>

        <pre style="margin: 0; background: transparent; border: none; padding: 0; flex: 1;"><code id="visor-codigo" style="color: #d4d4d4; font-family: Consolas, monospace; font-size: 13px; white-space: pre; line-height: 1.5;">/*
* 1. Haz clic en cualquier clase del panel izquierdo.
* 2. Usa la barra de búsqueda superior para filtrar la lista rápidamente.
*/</code></pre>
      </div>
    </div>
...
<script>
  ...
  function actualizarVisor(nombreArchivo) {
    ...
    var numeros = document.getElementById("numeros-linea");
    
    if (diccCodigos[nombreArchivo]) {
      var textoCodigo = diccCodigos[nombreArchivo];
      
      // 1. Inyectar el código fuente
      visor.textContent = textoCodigo;
      
      // 2. Actualizar el Breadcrumb del título
      titulo.innerHTML = "<span style=\'color: #4a90e2;\'>classes / </span><span style=\'color: #cccccc;\'>" + nombreArchivo + "</span>";
      
      // 3. Calcular y generar los números de línea dinámicamente
      var lineas = textoCodigo.split(/\\r?\\n/);
      var htmlNumeros = "";
      for(var i = 1; i <= lineas.length; i++) {
        htmlNumeros += i + "\\n";
      }
      numeros.textContent = htmlNumeros;
    }
  }
